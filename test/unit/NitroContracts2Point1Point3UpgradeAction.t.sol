...
import { Inbox as Inbox_2_1_0, IInboxBase as IInboxBase_2_1_0 } from '@arbitrum/nitro-contracts-2.1.0/src/bridge/Inbox.sol';
...
contract NitroContracts2Point1Point3UpgradeActionTest is
  Test,
  DeploymentHelpersScript
{
  ...
  function setUp() public {
    ...
    bridge_2_1_0 = address(
      new TransparentUpgradeableProxy(
        address(new Bridge_2_1_0()),
        address(proxyAdmin),
        ''
      )
    );
    ...
    erc20SequencerInbox_2_1_0 = address(
      new TransparentUpgradeableProxy(
        address(
          new SequencerInbox_2_1_0(
            maxDataSize,
            IReader4844_2_1_0(fakeReader),
            true
          )
        ),
        address(proxyAdmin),
    ...
    erc20Inbox_2_1_0 = address(
      new TransparentUpgradeableProxy(
        address(new ERC20Inbox_2_1_0(maxDataSize)),
        address(proxyAdmin),
        ''
      )
    );
    ...
    inbox_2_1_0 = address(
      new TransparentUpgradeableProxy(
        address(new Inbox_2_1_0(maxDataSize)),
        address(proxyAdmin),
        ''
      )
    );
    ...
    SequencerInbox_2_1_0(sequencerInbox_2_1_0).initialize(
      Bridge_2_1_0(bridge_2_1_0),
      ISequencerInbox_2_1_0.MaxTimeVariation(10, 10, 10, 10)
    );
    SequencerInbox_2_1_0(erc20SequencerInbox_2_1_0).initialize(
      Bridge_2_1_0(erc20Bridge_2_1_0),
      ISequencerInbox_2_1_0.MaxTimeVariation(10, 10, 10, 10)
    );
    Inbox_2_1_0(inbox_2_1_0).initialize(
      Bridge_2_1_0(bridge_2_1_0),
  ...
  function _deployActionScript()
    internal
    returns (NitroContracts2Point1Point3UpgradeAction)
  {
  ...
  function testEth() public {
    ...
    upgradeExecutor.execute(
      address(action),
      abi.encodeCall(action.perform, (inbox_2_1_0, proxyAdmin))
    );

    // check correctly upgraded
    assertEq(
      proxyAdmin.getProxyImplementation(
        TransparentUpgradeableProxy(payable(inbox_2_1_0))
      ),
      newEthInboxImpl
    );
    assertEq(
      proxyAdmin.getProxyImplementation(
        TransparentUpgradeableProxy(payable(sequencerInbox_2_1_0))
      ),
      newEthSeqInboxImpl
    );
  }
  ...
  function testERC20() public {
    ...
    upgradeExecutor.execute(
      address(action),
      abi.encodeCall(action.perform, (erc20Inbox_2_1_0, proxyAdmin))
    );

    // check correctly upgraded
    assertEq(
      proxyAdmin.getProxyImplementation(
        TransparentUpgradeableProxy(payable(erc20Inbox_2_1_0))
      ),
      newERC20InboxImpl
    );
    assertEq(
      proxyAdmin.getProxyImplementation(
        TransparentUpgradeableProxy(payable(erc20SequencerInbox_2_1_0))
      ),
      newErc20SeqInboxImpl
    );
  }
  ...
  function testERC20BelowV2() public {
    ...
    proxyAdmin.upgrade(
      TransparentUpgradeableProxy(payable(erc20Bridge_2_1_0)),
      newImpl
    );
    ...
    vm.expectRevert(
      'NitroContracts2Point1Point3UpgradeAction: bridge is an ERC20Bridge below v2.x.x'
    );
    upgradeExecutor.execute(
      address(action),
      abi.encodeCall(action.perform, (erc20Inbox_2_1_0, proxyAdmin))
  ...
  function testNotInbox() public {
    ...
    vm.mockCallRevert(
      address(inbox_2_1_0),
      abi.encodeWithSelector(IInboxBase_2_1_0.allowListEnabled.selector),
      ''
    );
    vm.expectRevert(
      'NitroContracts2Point1Point3UpgradeAction: inbox is not an inbox'
    );
    upgradeExecutor.execute(
      address(action),
      abi.encodeCall(action.perform, (inbox_2_1_0, proxyAdmin))
