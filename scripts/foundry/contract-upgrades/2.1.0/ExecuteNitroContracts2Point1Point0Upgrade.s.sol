...
import { NitroContracts2Point1Point0UpgradeAction, ProxyAdmin } from '../../../../contracts/parent-chain/contract-upgrades/NitroContracts2Point1Point0UpgradeAction.sol';
...
contract ExecuteNitroContracts2Point1Point0UpgradeScript is Script {
  function run() public {
    ...
    NitroContracts2Point1Point0UpgradeAction upgradeAction = NitroContracts2Point1Point0UpgradeAction(
    ...
    bytes memory upgradeCalldata = abi.encodeCall(
      NitroContracts2Point1Point0UpgradeAction.perform,
      (rollup, proxyAdmin)
    );
